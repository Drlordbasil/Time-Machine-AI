...
GITHUB_REPO_URL = "https://github.com/your-username/repository"
...
def fetch_weather_forecast(location):
    """
    Fetches and displays the weather forecast for the next 7 days for a specific location.
    :param location: The location for which to fetch the weather forecast.
    """
